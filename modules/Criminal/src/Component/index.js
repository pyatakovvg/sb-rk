...
export default function CriminalPage() {
  ...
  return (
    <PartitionLayout>
      ...
      <H4>Какие действия мы будем предпринимать:</H4>
