  ...
  return (
    <Suspense fallback={null}>
      <Partition>
        ...
        <ul className="ul">
          <li className="li">Возможность делегировать свои риски;</li>
          <li className="li">Гарантия выполнения указанного в договоре объема работ;</li>
          <li className="li">Всегда квалифицированные кадры, за которыми стоит группа профессионалов;</li>
          <li className="li">Использование передового опыта в области охраны труда;</li>
          <li className="li">Высвобождение времени руководителя, которое он может использовать рационально, сконцентрировавшись на главных стратегических целях и задачах своей организации;</li>
          <li className="li">Возможность проконсультироваться с экспертом в любое время;</li>
          <li className="li">Экономия бюджета на организацию рабочего места для штатного специалиста и уплату налогов с заработной платы;</li>
          <li className="li">Возможность комплексного обслуживания по охране труда, пожарной безопасности и экологии;</li>
        </ul>
        ...
        <p className="p"><b>Этапы оказания услуг по безопасности:</b></p>
        <ul className="ul">
          ...
          <li className="li">Осмотр объекта, выполнение измерений, фотофиксация и составление акта осмотра;</li>
          ...
          <li className="li">Подготовка необходимой документации;</li>
          <li className="li">Подписание акта оказанных услуг;</li>
          <li className="li">Выдача заказчику заключения;</li>
        </ul>
      </Partition>
    </Suspense>
  );
